...
@IntegrationTest
class ZooKeeperTest extends AkkaIntegrationFunTest with EmbeddedMarathonTest {
...
@IntegrationTest
class AuthorizedZooKeeperTest extends AkkaIntegrationFunTest with EmbeddedMarathonTest {
