...
import mesosphere.marathon.state.{ Timestamp, InstanceHandling }
...
object ScalingProposition {
  ...
  def propose(
    ...
    scaleTo: Int,
    killSelection: InstanceHandling.KillSelection = InstanceHandling.DefaultKillSelection): ScalingProposition = {
  ...
  /**
    ...
    */
  def sortByConditionAndDate(select: InstanceHandling.KillSelection)(a: Instance, b: Instance): Boolean = {
